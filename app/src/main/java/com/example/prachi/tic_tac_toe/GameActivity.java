...
public class GameActivity extends  AppCompatActivity implements View.OnClickListener {
    ...
    private void resetGame() {
        playerinfo.setText("Trun :" + playerName1);
        player1Chance = true;
        count = 0;
        pList1.clear();
        pList2.clear();
